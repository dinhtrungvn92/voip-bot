...
class Translator(object):
    ...
    def get_access_token(self):
        ...
        conn.request(method="POST", url=self.auth_path,
    ...
    def call(self, headerfields, path, body):
        ...
        conn.request(method="POST", url=urlpath,
                     headers=headerfields, body=body)
    ...
    def speak(self, text, lang, gender, format):
        ...
        try:
            ...
            raise LanguageException(
                "Invalid language/gender combination: %s, %s" % (lang, gender))
        ...
        body = "<speak version='1.0' xml:lang='%s'><voice xml:lang='%s' xml:gender='%s' name='%s'>%s</voice></speak>" % (
            lang, lang, gender, servicename, text)
